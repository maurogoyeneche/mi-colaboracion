      ...
      {list.map((item, index) => (
        <>
          <Card
            ...
            ${item.recommended ? "dark:bg-recommended-gradient" : "dark:bg-default-gradient"}`}
          >
            <span
              className={`${item.recommended ? "visible" : "hidden"} text-sm lg:text-xs text-center font-semibold transform scale-75 rounded-2xl border  dark:text-white w-[140px] px-4 py-1 mx-auto -mt-4 `}
            >
              RECOMENDADO
            </span>
